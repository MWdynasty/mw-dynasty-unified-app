...
module.exports=async(req,res)=>{
  ...
  try{
    ...
    if(req.method==='GET'){
      ...
      const [profiles,states,prs,notes,strengthMaxes,assignedCheckins]=await Promise.all([
