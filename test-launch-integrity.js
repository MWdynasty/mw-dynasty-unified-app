...
includes('athlete/index.html','MW Dynasty 3.0.16 · iOS Build 7','athlete visible app version mismatch');
includes('ios_v3_0_16_patch/Config/Release.xcconfig','MARKETING_VERSION = 3.0.16','iOS marketing version mismatch');
includes('ios_v3_0_16_patch/Config/Release.xcconfig','CURRENT_PROJECT_VERSION = 7','iOS build number mismatch');
